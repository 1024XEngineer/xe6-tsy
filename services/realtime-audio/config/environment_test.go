...
func TestLoadProviderConfigReadsQwenSettings(t *testing.T) {
	values := map[string]string{
		...
		"LLM_PROVIDER": "aliyun", "LLM_API_KEY": "llm-key", "LLM_ENABLE_THINKING": "true", "LLM_TIMEOUT_MS": "12000",
	...
	if !config.Translation.EnableThinking || config.Translation.Timeout != 12*time.Second {
